...
//    val upsertData = UpsertData(NewContact(idId, email, name, name, None, Some("n19gu"), uk, None, allowMail, allowMail, allowMail))
...
//    val upsertData = UpsertData(NewContact(idId, email, name, name, Some(state), Some("n19gu"), us, None, allowMail, allowMail, allowMail))
...
//    val upsertData = UpsertData(NewContact(idId, email, name, name, None, Some("n19gu"), uk, Some(telephoneNumber), allowMail, allowMail, allowMail))
